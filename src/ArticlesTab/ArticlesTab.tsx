...
export const ArticlesTab = () => {
    return (
        <div className="aside__content">
            ...
            <Image fluid src={process.env.PUBLIC_URL + '/geek_utopia.png'} style={{width: "100%", float: "left", borderRadius: "15px", paddingRight: "10px", paddingTop: "5px", alignSelf: "flex-start"}}></Image>
